  ...
  <Accordion title="Wyszukiwanie filtrami" icon="magnifying-glass">
    ...
    **Przykłady:**
    ...
    - Znając formatowanie nazw klientów, możemy wyszukiwać szpitale po mieście:\
      ...
      Np. wpisując "Poznań", zobaczymy rekordy z Wrzoska, Przybyszewskiego, Grunwaldzkiej itd.
  </Accordion>
</AccordionGroup>
...
- **Części** → przypisane do oferty zostaną te same rekordy co do zlecenia serwisowego. 
